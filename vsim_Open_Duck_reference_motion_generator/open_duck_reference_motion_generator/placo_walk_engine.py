...
class PlacoWalkEngine:
    def __init__(
        ...
        print("## self.parameters.single_support_duration:", self.parameters.single_support_duration)
        print("## self.parameters.double_support_duration():", self.parameters.double_support_duration())

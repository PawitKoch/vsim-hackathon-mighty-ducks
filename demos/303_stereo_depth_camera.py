...
env_def.import_definitions("assets/vsim/cartpole_stereo_depth_demo.vsim", fixed=True)
...
def grab_image():
    ...
    plt.savefig("303_stereo_depth_camera.png")
    print("Image saved in 303_stereo_depth_camera.png")

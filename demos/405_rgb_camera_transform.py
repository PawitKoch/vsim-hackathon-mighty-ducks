...
get_camera_transform_cmd = env_group.create_rgb_camera_transform_command(
    v.wrap_gpu_buffer(get_camera_transform_buf),
    camera_handle)

get_camera_transform_arr = gym.create_rgb_camera_transform_command_gpu_array(
    [get_camera_transform_cmd])

# == Setting RGB camera transform == #
...
# Create command
set_camera_transform_cmd = env_group.create_rgb_camera_transform_command(
    v.wrap_gpu_buffer(set_camera_transform_buf),
    camera_handle)

set_camera_transform_arr = gym.create_rgb_camera_transform_command_gpu_array(
    [set_camera_transform_cmd])

# Get initial camera transform
gym.get_rgb_camera_transforms(get_camera_transform_arr)
...
def set_distances():
    ...
    # Set distances
    gym.set_rgb_camera_transforms(set_camera_transform_arr)
